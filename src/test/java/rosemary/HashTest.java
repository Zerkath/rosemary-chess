...
public class HashTest {
    ...
    void hashingDifferentBoardsShouldProduceDifferentValues() {
        ...
        BoardState state2 = new BoardState("rnbqkbnr/pppp1p1p/6p1/3Pp3/8/8/PPP1PPPP/RNBQKBNR w KQkq e6 0 3");
    ...
    void hashingAfterEnPassantShouldProduceDifferentValue() {
        BoardState state1 = new BoardState("rnbqkbnr/pppp1p1p/6p1/3Pp3/8/8/PPP1PPPP/RNBQKBNR w KQkq e6 0 3");
    ...
    void hashingAfterCastlingShouldProduceDifferentValue() {
        BoardState state1 = new BoardState("rnb1kbnr/ppp1qpp1/3p3p/8/3P4/5N2/PPP1BPPP/RNBQK2R w KQkq - 0 6");
    ...
    void hashingAfterPromotionShouldProduceDifferentValue() {
        BoardState state1 = new BoardState("rnbqkbnr/pppp2P1/4p3/7p/8/8/PPPPPP1P/RNBQKBNR w KQkq - 0 5");
